...
const faqItems: FAQItem[] = [
    ...
    answer: (
      <>
        ...
        <ul>
          ...
          <li>A Gold Geek company check, which is sent via U.S.P.S. First Class Mail, generally arrives in 3 to 7 days</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <p>At Gold Geek we work hard to make sure that you receive the highest payout possible for your stuff. Other gold buyers are just interested in the buy-and-melt option. We prefer to find your precious pieces a new home by identifying a buyer from among our extensive list of clients around the world. Re-purposing and scrapping are our last resorts.</p>
    ),
  },
  {
  ...
  },
  {
    ...
    question: "Does Gold Geek provide written appraisals?",
    answer: (
  ...
  },
  {
    ...
    answer: (
      <p>Our FREE appraisal kits are very safe. They have a tamper-proof, heavy-duty plastic bag and a durable bubble mailer to cushion your materials. If you have any concerns, or think you might need additional packaging, please call customer service at 1-833-446-5343.</p>
    ),
  },
  {
