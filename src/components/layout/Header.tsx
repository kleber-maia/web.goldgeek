                  ...
                  <div className="elementor-widget-container">
                    ...
                    >
                      ...
                      >
                        ...
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-dashboard">
                          <a href="/user/login" className="elementor-item">
                            My Dashboard
                          </a>
                        </li>
                      </ul>
